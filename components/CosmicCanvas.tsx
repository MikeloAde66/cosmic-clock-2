      ...
      {activeView === 'clock' && (
        <>
          ...
          <main className="relative flex items-center justify-center flex-1 p-6 overflow-hidden">
            ...
            {/* Slow, hypnotic Apple-style camera drift — kept for the moon
                below, which still breathes gently rather than sitting
                perfectly static. The Earth sphere, its markers, and the
                marker-preview card that only existed for marker clicks were
                removed from here; the moon keeps its exact original
                position since this wrapper's size/centering is unchanged. */}
